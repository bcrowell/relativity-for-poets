...
\section{Velocities don't simply add}\label{sec:velocities-do-not-add}
...
\sectionwithsurtitle{Science and society}{Scientific revolutions}{Scientific revolutions}
...
\fig[h]{duck-rabbit-illusion}

A controversial alternative to Popper comes from Thomas Kuhn (1922-1996), who argues that
science operates in two different modes, a normal one in which knowledge is steadily accumulated,
and revolutionary steps, or \emph{paradigm shifts}. According to Kuhn,
